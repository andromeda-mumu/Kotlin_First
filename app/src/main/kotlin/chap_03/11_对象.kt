package chap_03//package chap_03
//
///**
...
////}
//
///** 这就是对象声明，并且它总是在object关键字后跟一个名称，就像变量声明一样，对象声明不是一个表达式，不能用在赋值语句都右边
// * 对象声明都初始化过程是线程安全得  并且在首次访问时进行
// * 如需引用该对象，我们直接使用其名称即可
// * */
...
////}
//
///** 对象声明不能在局部作用域找那（即直接嵌套在函数内部）,但是它们可以嵌套到其他对象声明或非内部类中*/
//
...
//val y = d2
//
///** 注意：即使伴生对象都成员看起来像其他语言都静态成员，在运行时他们仍然是真实对象都实例成员，而且，例如还可以实现接口*/
//interface Factory<T>{
//    fun create() :T
//}
//class cls{
